...
def ground_truth_label(img, layer ):
    ...
    ''' Fill foreground with black color '''
    ...
    try:
        # Save as PNG
        gimp.pdb.file_png_save(img, layer, outputFolder+'/labels/'+layer.name, "raw_filename", 0, 9, 0, 0, 0, 0, 0)
        gimp.message("Image saved in " + outputFolder+'labels/'+layer.name )
...
register(
    "python_fu_generate_ground_truth",
    "Generate Ground Truth",
    "Generate ground truth and save the current it in the labels folder",
    "YSDI",
    "Nothing",
    "October, 2016",
    "<Image>/Filters/Test/Generate Ground Truth v1",
    "*",
    [],
    [],
    ground_truth_label)
